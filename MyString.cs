...
namespace ConsoleApp6
{
    class MyString
    {
        ...
        public static int Compare(MyString strF, MyString strT) // сравнение
        {
            int result = 0;

            int min = Math.Min(strF.Len, strT.Len);

            for (int i = 0; i < min; i++)
            {
                int a = (int)strF.str[i];
                int b = (int)strT.str[i];
        ...
        public static int Compare(MyString strF, string strT) // сравнение
        {
            int result = 0;

            int min = Math.Min(strF.Len, strT.Length);
